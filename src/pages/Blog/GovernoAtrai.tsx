...
export const GovernoAtrai = () => {
    return (
        <div>
            <Navbar />
            <BlogBanner image='/static/img/page_blog/governo-atrai.png'/>
            <Box className="pt-36 pb-12">
            <Container>
                <StyledBox>
                        <Box className="lg:w-[100%]">
                            <StyledH2>
                                Governo atrai investimento de R$ 16,8 bi em ferrovias
                            </StyledH2>
                        </Box>
                </StyledBox>
                ...
                <Box className="mt-20 flex flex-col gap-8">
                    ...
                    <StyledP color="#707070" fontFamily="Myriad Regular" fontSize="1.125rem">
                    O complexo ferroviário deverá se tornar um dos mais importantes ramais logísticos do país para importação e exportação de produtos. O projeto deverá gerar 2 mil empregos diretos e impactar outros milhares indiretamente.
                    </StyledP>
                    ...
                    <StyledP color="#707070" fontFamily="Myriad Regular" fontSize="1.125rem">
                    O desenvolvimento das ferrovias sempre foi tratado com prioridade na gestão do governador Romeu Zema. Tanto que Minas Gerais, que tem a maior malha ferroviária do país, foi o primeiro estado a desenvolver o Plano Estratégico Ferroviário (PEF), apontando caminhos para expandir a participação desse modal no sistema de transporte. O estudo apontou diversos trechos viáveis de transporte de cargas e trens de passageiros regionais e metropolitanos. Ao todo, Minas poderá ganhar cerca de 5 mil quilômetros de ferrovias nos próximos anos, significando dobrar a quantidade existente.
                    </StyledP>

                    <StyledP color="#707070" fontFamily="Myriad Regular" fontSize="1.125rem">
                    O governo federal também está empenhado em alavancar o setor com o Marco Legal do Transporte Ferroviário, sancionado em dezembro de 2021, que pretende impulsionar a revitalização de trechos existentes e a construção de novos para modernizar o transporte em todo o país.
                    </StyledP>

                    <StyledP color="#707070" fontFamily="Myriad Regular" fontSize="1.125rem">
                    Até agora, o Ministério da Infraestrutura recebeu 80 pedidos de 32 diferentes entes privados interessados em desenvolver projetos ferroviários no país dentro do programa. Somados, os requerimentos têm potencial de injetar R$ 244,6 bilhões em investimentos privados no modal. Minas Gerais deve receber aportes entre R$ 70 bilhões e R$ 80 bilhões.
                    </StyledP>
                </Box>
                <Box className="mt-10">
                <StyledP color="#000" fontFamily="Myriad Regular" fontSize="1.125rem">
                Fonte: Governo atrai investimento de R$ 16,8 bi em ferrovias. Agência Minas. 2022. Disponível em: 
                </StyledP>
                <StyledP color="text-blue-500" fontFamily="Myriad Regular" fontSize='1.125rem'>
                <a className="text-blue-500 overflow-hidden w-[100%] flex" target='_blank' href="https://www.agenciaminas.mg.gov.br/noticia/governo-atrai-investimento-de-r-16-8-bi-em-ferrovias">https://www.agenciaminas.mg.gov.br/noticia/governo-atrai-investimento-de-r-16-8-bi-em-ferrovias</a>
                </StyledP>
                </Box>
                <BlogSlider />
            </Container>
